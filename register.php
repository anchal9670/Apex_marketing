           ...
           <div id="login-row" class="row justify-content-center align-items-center">
               <div id="login-column" class="col-md-12">
                   <div id="login-box" class="col-md-12">
                       <form id="login-form" class="form" action="registeraction.php" method="post">
                           <h3 class="text-center text-success">Register</h3>
                           <div class="form-group">
                               <label for="name" class="text-primary">Enter Name:</label><br>
                               <input type="text" name="name" id="name" class="form-control" required>
                           </div>
                           <div class="form-group">
                               <label for="mobile" class="text-primary">Mobile No.:</label><br>
                               <input type="mob" name="mobile" id="mobile" class="form-control" required>

                           </div>
                           <div class="form-group">
                               <label for="email" class="text-primary">Enter E-mail.:</label><br>
                               <input type="email" name="email" id="email" class="form-control" required>
                           </div>
                           <div class="form-group">
                               <label for="password" class="text-primary">Create Password:</label><br>
